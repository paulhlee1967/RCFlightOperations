...
- **Member self-service** — Passwordless `/membership` magic-link profile for contact, AMA, TRUST attestation, uploads, and email prefs ([docs/members.html](docs/members.html#self-service))

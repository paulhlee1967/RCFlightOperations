<?php
/**
 * my.php — Request a magic link to the member self-service profile.
 */
    ...
    <div class="col-md-6 col-lg-5">
        <div class="card shadow-sm border-0">
            <div class="card-body p-4">
                <h1 class="h4 mb-2">My Membership</h1>
                ...
                <?php elseif ($sent): ?>
                    ...
                    <p class="small text-muted mb-0">
                        Already have an open link? <a href="my_profile.php">Continue to your profile</a>
                        (only works after you have opened a valid link).
                    </p>
                <?php else: ?>
                    <form method="post" action="my.php" novalidate>
                        <?= csrf_field() ?>
                        <div class="mb-3">
                            <label class="form-label" for="email">Email on file</label>
                            <input type="email" class="form-control" name="email" id="email"
                                   value="<?= h($_POST['email'] ?? '') ?>" required autocomplete="email" autofocus>
                        </div>
